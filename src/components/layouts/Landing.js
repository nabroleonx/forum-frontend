      ...
      <main>
        ...
        >
          ...
          <a className="flex justify-center items-center my-8" href="#bit_head">
            <span className="animate-bounce inline-flex items-center justify-center p-3 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-full shadow-lg">
              <ArrowDownIcon
                className="h-6 w-6 text-white"
                aria-hidden="true"
              />
        ...
        {/* Blog section */}
        {/* <div className="relative bg-gray-50 py-6 sm:py-8 lg:py-12" id="blog">
